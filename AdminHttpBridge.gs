...
function adminIssueResumeLink_(token,leadId,ttlHours){
  ...
  return{success:true,leadId:issued.leadId,expiresAt:issued.expiresAt,relativeUrl:'/regalo-galicia?resume='+encodeURIComponent(issued.token)+'&source=galicia_recovery_email'};
}
